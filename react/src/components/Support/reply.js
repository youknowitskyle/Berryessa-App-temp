...
class ReplyBase extends Component {
  ...
  onListenForReplies() {
    ...
    this.props.firebase
      .replies(this.props.support.uid)
  ...
  componentWillUnmount() {
    this.props.firebase.replies(this.props.support.uid).off();
  }
  ...
  onCreateReply = (event, authUser) => {
    this.props.firebase.replies(this.props.support.uid).push({
      text: this.state.text,
      supportId: this.props.support.uid,
      userId: authUser.uid,
  ...
  onEditReply = (reply, text) => {
    ...
    this.props.firebase
      .reply(this.props.support.uid)(reply.uid)
      .set({
        ...replySnapshot,
        text,
  ...
  onRemoveReply = uid => {
    this.props.firebase
      .reply(this.props.support.uid)(uid)
      .remove();
  };
